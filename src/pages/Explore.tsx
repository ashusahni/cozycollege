...
// Sample property data for Indian context
const allProperties: Omit<PropertyCardProps, 'className'>[] = [
  ...
  {
    id: '7',
    name: 'Kota Student Residence',
    location: 'Near Allen Institute, Kota',
    distance: '0.6 km',
    price: 9500,
    rating: 4.2,
    reviews: 91,
  ...
  {
    id: '8',
    name: 'Manipal University Hostel',
